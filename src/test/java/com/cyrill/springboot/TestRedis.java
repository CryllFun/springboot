...
public class TestRedis {
    ...
    public void test() throws Exception{
        ...
        Assert.assertEquals("111",stringRedisTemplate);
    }
...
//        手动使用缓存
        ...
        User user = new User("aa","aa@qq.com","aa123","aa123456",formattedDate);
        ...
        if (exists){
            System.out.println("com.neo.f存在");
        }else {
            System.out.println("com.neo.f不存在");
        }
